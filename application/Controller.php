...
class Controller
{
	...
	public function vallidateInAdmin(){
	...
	#metodo para validar que el usuario tenga el rol de 
	#llustrador (especialmente para subir y gestionar productos)
	public function vallidateInIlu(){

		$this->validateSession();
		Session::time();
		$this->validateRol(['Ilustrador']);

	}
	#metodo para validar que el usuario tenga un rol interno del sistema
	#(hasta ahora administrador y ilustrador), separado especialmente para 
	#validaciones generales del sistema interno
	public function vallidateInSuperUser(){

		$this->validateSession();
		Session::time();
		$this->validateRol(['Administrador','Ilustrador']);

	}
	#metodo para validar que un usuario tenga el rol de usuario (rol "publico")
	public function vallidateInUser(){

		$this->validateSession();
		Session::time();
		$this->validateRol(['Usuario']);
